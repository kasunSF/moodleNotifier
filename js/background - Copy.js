...
function fetchEvents() {
    ...
    try {
        ...
        //num_of_event_types = responseText.match(/collapsibleregioninner/g).length;//Get number of available event types
        //num_of_events = responseText.match(/collapsibleregioninner/g).length;//Get number of available event types
